...
@freestanding(codeItem) macro go(emit: StrSlice) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go<S: ExpressibleByStringLiteral>(appendComment: S, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go(appendAttrValue: StrSlice) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
...
@freestanding(codeItem) macro go<S: ExpressibleByStringLiteral>(error: ParseError, createComment: S, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go(error: ParseError, appendComment: Char) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
@freestanding(codeItem) macro go<S: ExpressibleByStringLiteral>(error: ParseError, appendComment: S, to: State) = #externalMacro(module: "TokenizerMacros", type: "GoMacro")
